...
The idea is simple: before importing a contact list into another system, I want a quick way to clean it, catch issues, and remove duplicates, ideally in a safe “dry-run” first.
...
python src/main.py --input data/sample_leads.csv --dry-run
